...
interface BOATokenBridgeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "increaseLiquidity(address,uint256)": FunctionFragment;
    "isManager(address)": FunctionFragment;
    "isOwner(address)": FunctionFragment;
    "liquidBalance(address)": FunctionFragment;
    "openDeposit(bytes32,uint256,uint256,uint256,address,bytes32)": FunctionFragment;
...
export class BOATokenBridge extends BaseContract {
  ...
  interface: BOATokenBridgeInterface;
