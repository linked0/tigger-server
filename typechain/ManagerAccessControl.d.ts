...
interface ManagerAccessControlInterface extends ethers.utils.Interface {
  functions: {
...
export class ManagerAccessControl extends BaseContract {
  ...
  interface: ManagerAccessControlInterface;
